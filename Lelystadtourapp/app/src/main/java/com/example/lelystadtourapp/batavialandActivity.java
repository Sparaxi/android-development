...
public class batavialandActivity extends AppCompatActivity {
    TextView infotext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_batavialand);
        infotext = findViewById(R.id.info_text_batavialand);
        info = findViewById(R.id.info_textview_batavialand);
        infobackgroundview = findViewById(R.id.info_background_view);
        hide = findViewById(R.id.info_hide);
        Home = findViewById(R.id.home_textview_batavialand);
    }
