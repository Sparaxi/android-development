...
public class bataviastadActivity extends AppCompatActivity {
    TextView infotext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bataviastad);
        infotext = findViewById(R.id.info_text_bataviastad);
        info = findViewById(R.id.info_textview_bataviastad);
        infobackgroundview = findViewById(R.id.info_background_view);
        hide = findViewById(R.id.info_hide);
        Home = findViewById(R.id.home_textview_bataviastad);
    }
